...
CATEGORIES = {
    ...
    "2 - HARDWARE INFORMATION": {
        ...
        "hdparm -tT /dev/${sda}$": "Perform a read speed test on disk as sda",
        "badblocks -s /dev/${sda}$": "Test for unreadable blocks on disk sda",
        "lshw": "Display information about CPU, memory, storage, and network interfaces",
    ...
    "4 - USER INFORMATION AND MANAGEMENT": {
        ...
        "groupadd ${group}$": "Create a group named group.",
        "useradd -c ${comment -m ${user}$": "Create an account named user, with a comment of comment and create the user's home directory.",
        "userdel ${user}$": "Delete the user account.",
        "usermod -aG ${group}$ ${user}$": "Add the user account to the group",
    },
    "5 - FILE AND DIRECTORY COMMANDS": {
        "ls -al": "List all files in a long listing (detailed) format",
        "pwd": "Display the present working directory",
        "mkdir ${directory}$": "Create a directory directory",
        "rm ${file}$": "Remove (delete) file file",
        "rm -r ${directory}$": "Remove the directory and its contents recursively",
        "rm -f ${file}$": "Force removal of file file without prompting for confirmation",
        "rm -rf ${directory}$": "Forcefully remove directory directory recursively",
        ...
        "mv ${file1}$ ${file2}$": "Rename or move file1 to file2. If file1 is an existing directory, move file1 into directory file2",
    ...
    "7 - FILE PERMISSIONS": {
        ...
        "chown ${user}$ ${/path/to/file}$": "Change ownership of /path/to/file to john",
        "chgrp ${group}$ ${/path/to/file}$": "Change group ownership of /path/to/file to group sales",
    },
    "8 - NETWORKING": {
        ...
        "tcpdump": "apture and analyze network traffic",
    },
    ...
    "10 - INSTALLING PACKAGES": {
        ...
        "tar zxvf ${sourcecode.tar.gz}$ && cd ${sourcecode && ./configure && make && make install": "Install package from source code",
    ...
    "11 - SEARCH": {
        ...
        "whereis ${program}$": "Display the location of the binary, source and manual page files of program.",
        "which ${program}$": "Display the path of executable that would run if program is executed.",
    },
    "12 - SSH LOGINS": {
